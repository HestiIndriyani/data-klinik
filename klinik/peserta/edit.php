...
$q = mysqli_query($conn,"SELECT * FROM peserta WHERE kode_peserta='$id'");
...
<div class="form-box">
  <form method="POST">
    <div class="form-row">
      ...
      <input type="text" name="kode" value="<?= $data['kode_peserta'] ?>" readonly>
    </div>
...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE peserta SET nama_peserta='$nama' WHERE kode_peserta='$id'";
