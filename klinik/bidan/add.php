...
<h3 style="text-align:center">Tambah Bidan</h3>
...
if(isset($_POST['simpan'])){
    ...
    $poli  = mysqli_real_escape_string($conn,$_POST['kode_poli']);

    $sql = "INSERT INTO bidan (kode_bidan,nama_bidan,kode_poli) 
            VALUES ('$kode','$nama','$poli')";
